    ...
    private void seedDataBase() {
        ...
        UserEntity[] users = {
                ...
                UserEntity.builder().mobile("666666004").firstName("c2").familyName("ac2").password(pass).dni("66666604T")
                        ...
                        .registrationDate(LocalDateTime.now()).active(true).build(),
                UserEntity.builder().mobile("666666005").firstName("c3").password(pass).scope(Scope.CUSTOMER)
                        .registrationDate(LocalDateTime.now()).active(true).build(),
                UserEntity.builder().mobile("66").firstName("customer").password(pass).scope(Scope.CUSTOMER)
                        .registrationDate(LocalDateTime.now()).active(true).build(),
        };
